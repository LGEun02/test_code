...
<body>
	...
	<%
		sql="select nvl(max(player_no),0)+1 player_no from player_tbl_09";
	...
	<section>
		...
		<form action="insertpro.jsp" method="post" name="f">
			<table style="margin: 0 auto;" border="1" width="400">
				...
				<tr>
					<th>이름</th>
					<td><input type="text" name="player_name" size="15" maxlength="20"></td>
				</tr>
				<tr>
					<th>소속팀번호</th>
					<td><input type="text" name="team_no" size="15" maxlength=""></td>
				</tr>
				<tr>
					<th>연락처</th>
					<td><input type="text" name="player_phone" size="15" maxlength="14"></td>
				</tr>
				<tr>
					<th>생년월일</th>
					<td><input type="text" name="player_birth" size="15"></td>
				</tr>
				<tr>
					<th>메일주소</th>
					<td><input type="text" name="player_email" size="15" maxlength="50"></td>
				</tr>
				<tr>
					<th>등번호</th>
					<td><input type="text" name="back_no" size="15"></td>
				</tr>
			</table>
			<center>
