	...
	<section>
		...
		<form action="updatepro.jsp" method="post" name="f">
			<table style="margin: 0 auto;" border="1" width="500">
				...
				<tr>
					<th>회원성명</th>
					<td><input type="text" name="custname" value="<%=rs.getString("custname") %>" size="15" maxlength="20"></td>
				</tr>
				<tr>
					<th>회원전화</th>
				...
				<tr>
					<th>회원주소</th>
					<td><input type="text" name="address" value="<%=rs.getString("address") %>" size="30" maxlength="60"></td>
				</tr>
				<tr>
					<th>가입일자</th>
				...
				<tr>
					...
					<td><input type="text" name="grade" value="<%=rs.getString("grade") %>" size="15" maxlength="1"></td>
				</tr>
				<tr>
					<th>도시코드</th>
					<td><input type="text" name="city" value="<%=rs.getString("city") %>" size="15" maxlength="2"></td>
				</tr>
				<tr>
					<th colspan="2">
